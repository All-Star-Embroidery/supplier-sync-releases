...
class ASSS_Admin {
    ...
    public function settings(): void {
        ...
        echo '<tr><th>Adapter status</th><td><strong>' . esc_html(!empty($momentec['configured']) ? 'Momentec GitHub bridge enabled' : 'Momentec bridge disabled') . '</strong><p class="description">Momentec production v2 username/password authentication is verified in GitHub Actions. Catalog style lookups and targeted inventory sync run from GitHub; WordPress never receives the credentials.</p></td></tr></table>';
