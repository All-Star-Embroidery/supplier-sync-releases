 ...
 * Description: Curated supplier-to-WooCommerce synchronization framework. SanMar and S&S Activewear connectors included.
 * Version: 2.0.2
 * Author: All Star
...
final class ASSS_Plugin {
    ...
    public function boot(): void {
        ...
        $this->admin = new ASSS_Admin($this->sanmar, $this->ss, $this->importer, $this->sync, $this->multi, $this->updater);
